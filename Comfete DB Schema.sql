...
(1, '../adimg/select/Adobe_Illustrator.png', 'Steve Jobs', 'James Gosling', 'Dennis Ritchie', 'Rasmus Lerdorf'),
(2,  '../adimg/select/airbnb.png', 'op1', 'op2', 'op3', 'op4'),
(3,  '../adimg/select/amd.png', 'op1', 'op2', 'op3', 'op4'),
(4,  '../adimg/select/brave.png', 'op1', 'op2', 'op3', 'op4'),
(5,  '../adimg/select/ChatGPT.png', 'op1', 'op2', 'op3', 'op4'),
(6,  '../adimg/select/meta.png',  'op1', 'op2', 'op3', 'op4'),
(8,  '../adimg/select/mysql logo.png', 'op1', 'op2', 'op3', 'op4'),
(7,  '../adimg/select/nestle.jpg', 'op1', 'op2', 'op3', 'op4'),
(9,  '../adimg/select/netscape navigator.png', 'op1', 'op2', 'op3', 'op4'),
(10, '../adimg/select/nvidia.png', 'op1', 'op2', 'op3', 'op4'),
(11, '../adimg/select/openOfficeLogo.png', 'op1', 'op2', 'op3', 'op4'),
(12, '../adimg/select/Stack_Overflow.png', 'op1', 'op2', 'op3', 'op4'),
(13, '../adimg/select/tesla.png', 'op1', 'op2', 'op3', 'op4'),
(14, '../adimg/select/tor_browser.jpg', 'op1', 'op2', 'op3', 'op4'),
(15, '../adimg/select/ubuntu.png', 'op1', 'op2', 'op3', 'op4'),
(16, '../adimg/select/16.png', 'op1', 'op2', 'op3', 'op4'),
(17, '../adimg/select/17.png', 'op1', 'op2', 'op3', 'op4'),
(18, '../adimg/select/18.png', 'op1', 'op2', 'op3', 'op4'),
(19, '../adimg/select/19.png', 'op1', 'op2', 'op3', 'op4'),
(20, '../adimg/select/20.png', 'op1', 'op2', 'op3', 'op4'),
(21, '../adimg/select/21.png', 'op1', 'op2', 'op3', 'op4'),
(22, '../adimg/select/22.png', 'op1', 'op2', 'op3', 'op4'),
(23, '../adimg/select/23.png', 'op1', 'op2', 'op3', 'op4'),
(24, '../adimg/select/24.png', 'op1', 'op2', 'op3', 'op4'),
(25, '../adimg/select/25.png', 'op1', 'op2', 'op3', 'op4'),
(26, '../adimg/select/26.png', 'op1', 'op2', 'op3', 'op4'),
(27, '../adimg/select/27.png', 'op1', 'op2', 'op3', 'op4'),
(28, '../adimg/select/28.png', 'op1', 'op2', 'op3', 'op4'),
(29, '../adimg/select/29.png', 'op1', 'op2', 'op3', 'op4'),
(30, '../adimg/select/30.png', 'op1', 'op2', 'op3', 'op4');
